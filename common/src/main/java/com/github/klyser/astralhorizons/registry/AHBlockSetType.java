...
public class AHBlockSetType {
    ...
    public static final BlockSetType SCURANE = BlockSetType.register(new BlockSetType("scurane", true, SoundType.CHERRY_WOOD,
    ...
    public static final BlockSetType ANOMASTONE = BlockSetType.register(new BlockSetType("anomastone",true, SoundType.STONE,
