package com.github.klyser.astralhorizons.fabric.datagen.sound;
...
import static com.github.klyser.astralhorizons.fabric.datagen.sound.SoundDefinition.Sound.sound;
import static com.github.klyser.astralhorizons.fabric.datagen.sound.SoundDefinition.definition;

public class AHSoundProvider extends SoundsJsonProvider {
    public AHSoundProvider(FabricDataOutput dataOutput) {
        super(dataOutput);
    }
